...
//    #define XMSS_VARIANT "XMSS-LSH_10_256"
//#endif
//
//int main()
//{
...
//        }
//
//        printf("Before Flipping first bit \n");
//        printf("smlen : %lld\n",smlen);
//        // Test if flipping bits invalidates the signature (it should).
//        for(int z=0; z<32; z++) printf("%02X ", sm[z]);
//        
...
//        
//        if (!XMSS_SIGN_OPEN(mout, &mlen, sm, smlen, pk)) {
//            printf("[error1-flip first bit]  X flipping a bit of m DID NOT invalidate signature!\n");
//            ret = -1;
//        }
//        else {
//            printf("[success]    flipping a bit of m invalidates signature.\n");
//        }
//        sm[smlen-1] ^= 1;
//
...
//            sm[j] ^= 1;
//            if (!XMSS_SIGN_OPEN(mout, &mlen, sm, smlen, pk)) {
//                printf("[error2]  X flipping bit %d DID NOT invalidate sig + m!\n", j);
//                sm[j] ^= 1;
//                ret = -1;
//                break;
//            }
